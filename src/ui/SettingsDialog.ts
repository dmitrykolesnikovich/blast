...
import Avatar, {Gender} from "./views/Avatar"
    ...
    constructor(navigation: Navigation) {
        ...
        this.layout = {
            ...
            toggleSound: new Button({
                ...
                backgroundDisabled: buttonCheckboxDisabled,
            ...
            buttonHelp: new Button({
                ...
                click: () => navigation.navigateHelpDialog()
            }),
            buttonInfo: new Button({
                ...
                background: buttonRadioPng,
                backgroundSize: {width: 48, height: 48},
                click: () => navigation.navigateAboutDialog()
            }),
        }
    }

    focused({model, navigation}: GameController) {
        const {radioButtons} = this.layout
        radioButtons.layout.select = (item: string) => {
            model.profile.gender = item as Gender
            navigation.update()
        }
    }
